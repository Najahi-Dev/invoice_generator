...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-zinc-200/80 px-3 sm:px-6 py-2 sm:py-2.5 print:hidden">
      <div className="max-w-[1520px] mx-auto flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex lg:hidden items-center bg-zinc-100/90 p-0.5 rounded-[4px] border border-zinc-200/90 shadow-2xs">
          <button
            onClick={() => setActiveTab("editor")}
            className={`flex items-center gap-1 px-2.5 sm:px-3 py-1 text-xs font-medium rounded-[3px] transition-all cursor-pointer ${
              activeTab === "editor"
